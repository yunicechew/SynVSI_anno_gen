        ...
        try:
            ...
            for actor_name in actor_combo:
                ...
                actor_data.append({
                    ...
                    'CleanedActorName': actor_row['CleanedActorName'],
            ...
            question_names = [actor['CleanedActorName'] for actor in question_order]
            ...
            answer = f"{', '.join([actor['CleanedActorName'] for actor in actor_data])}"
